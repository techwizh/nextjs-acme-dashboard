...
Dashboard app from the [Next.js App Router Course](https://nextjs.org/learn/dashboard-app).
...
- [Technical Documentation](./docs/DOCUMENTATION.md) — Setup, architecture, and deployment
